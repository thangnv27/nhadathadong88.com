...
if (!function_exists('of_options'))
{
    ...
    function of_options()
    {
        ...
        */
        ...
        $options[] = array( "name" => __('Banner Top','framework'),
            "desc" => __('Upload banner, size: 728x90 px','framework'),
        ...
        $options[] = array( "name" => __('Select the search fields that you want to display in search form.','framework'),
            ...
            "std" => array(
                'property-id', 'location', 'status', 'type', 'min-beds', 'min-baths', 'min-max-price', 'min-max-area', 'direction', 'project'
            ),
            "type" => "multicheck",
            "options" => array(
                ...
                'direction' => __('Property Direction','framework'),
                'project' => __('Property Project','framework')
            ));
        ...
        $options[] = array( "name" => __('Property Title Hover Color','framework'),
            "desc" => __('Choose a color for proeprty title hover. Base theme color is #df5400.','framework'),
