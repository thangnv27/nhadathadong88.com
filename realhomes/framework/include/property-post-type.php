...
if( !function_exists( 'build_taxonomies' ) ){
    function build_taxonomies(){
        ...
        $direction_labels = array(
            'name' => __( 'Property Direction', 'framework' ),
            'singular_name' => __( 'Property Direction', 'framework' ),
            'search_items' =>  __( 'Search Property Direction', 'framework' ),
            'popular_items' => __( 'Popular Property Direction', 'framework' ),
            'all_items' => __( 'All Property Direction', 'framework' ),
            'parent_item' => __( 'Parent Property Direction', 'framework' ),
            'parent_item_colon' => __( 'Parent Property Direction:', 'framework' ),
            'edit_item' => __( 'Edit Property Direction', 'framework' ),
            'update_item' => __( 'Update Property Direction', 'framework' ),
            'add_new_item' => __( 'Add New Property Direction', 'framework' ),
            'new_item_name' => __( 'New Property Direction Name', 'framework' ),
            'separate_items_with_commas' => __( 'Separate Property Direction with commas', 'framework' ),
            'add_or_remove_items' => __( 'Add or remove Property Direction', 'framework' ),
            'choose_from_most_used' => __( 'Choose from the most used Property Direction', 'framework' ),
            'menu_name' => __( 'Property Direction', 'framework' )
        );
        ...
        register_taxonomy(
            ...
            array(
                ...
                'show_ui' => true,
                'query_var' => true,
                'rewrite' => array('slug' => __('property-direction', 'framework'))
            )
        );
        
        $project_labels = array(
            'name' => __( 'Property Project', 'framework' ),
            'singular_name' => __( 'Property Project', 'framework' ),
            'search_items' =>  __( 'Search Property Project', 'framework' ),
            'popular_items' => __( 'Popular Property Project', 'framework' ),
            'all_items' => __( 'All Property Project', 'framework' ),
            'parent_item' => __( 'Parent Property Project', 'framework' ),
            'parent_item_colon' => __( 'Parent Property Project:', 'framework' ),
            'edit_item' => __( 'Edit Property Project', 'framework' ),
            'update_item' => __( 'Update Property Project', 'framework' ),
            'add_new_item' => __( 'Add New Property Project', 'framework' ),
            'new_item_name' => __( 'New Property Project Name', 'framework' ),
            'separate_items_with_commas' => __( 'Separate Property Project with commas', 'framework' ),
            'add_or_remove_items' => __( 'Add or remove Property Project', 'framework' ),
            'choose_from_most_used' => __( 'Choose from the most used Property Project', 'framework' ),
            'menu_name' => __( 'Property Project', 'framework' )
        );
        ...
        register_taxonomy(
            ...
            array(
                ...
                'show_ui' => true,
                'query_var' => true,
                'rewrite' => array('slug' => __('property-project', 'framework'))
            )
        );
    }
}
