...
//                wp_register_script('google-map-api', '//maps.google.com/maps/api/js?sensor=true', array(), '', false);
                wp_register_script('google-map-api', '//maps.google.com/maps/api/js?key=AIzaSyDOx28-QfBMmHXK_cndfBb8iFV8EhXqSWc', array(), '', false);
...
if(!function_exists('advance_hierarchical_options')){
    function advance_hierarchical_options($taxonomy_name){
        ...
        if($taxonomy_name == 'property-direction'){
            if(!empty($_GET['direction'])){
                $searched_term = $_GET['direction'];
            }
        }

        if($taxonomy_name == 'property-project'){
            if(!empty($_GET['project'])){
                $searched_term = $_GET['project'];
            }
        }
...
//    'plugins.php', 'plugin-install.php', 
    $basename_excludes = array('plugin-editor.php', 'theme-install.php', 'theme-editor.php', 'import.php', 'export.php');
