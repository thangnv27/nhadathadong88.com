...
<div class="as-form-wrap">
    ...
    if(in_array('direction',$theme_search_fields)){
        ?>
        <div class="option-bar large">
            <label for="select-property-direction"><?php _e('Property Direction', 'framework'); ?></label>
            <span class="selectwrap">
                <select name="direction" id="select-property-direction" class="search-select">
                    <?php advance_hierarchical_options('property-direction'); ?>
                </select>
            </span>
        </div>
        <?php
    }
    if(in_array('project',$theme_search_fields)){
        ?>
        <div class="option-bar large">
            <label for="select-property-project"><?php _e('Property Project', 'framework'); ?></label>
            <span class="selectwrap">
                <select name="project" id="select-property-project" class="search-select">
                    <?php advance_hierarchical_options('property-project'); ?>
                </select>
            </span>
        </div>
        <?php
